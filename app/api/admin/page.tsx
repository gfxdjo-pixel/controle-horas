...
import { Users, ArrowLeft, Truck, Mail, FileDown, Calendar as CalendarIcon, Gauge, MapPinned, Info } from 'lucide-react';
...
export default function AdminPanel() {
  ...
  if (loading) return <div className="min-h-screen bg-[#0f172a] flex items-center justify-center text-white">Carregando Painel Master...</div>;
